interface fifo_interface(wclk, rclk);
    ...
    modport TEST (output rst_n, r_en, w_en, wdata, 
                 input wclk, rclk, rdata, fifo_full, fifo_empty, start_sampling);

    modport MONITOR (input wclk, rclk, rst_n, r_en, w_en, wdata, rdata, fifo_full, fifo_empty, start_sampling);
endinterface